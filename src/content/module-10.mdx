...
<Callout type="warning" title="CREATE TABLE AS no copia restricciones">
...
<Callout type="warning" title="No olvides el WHERE">
...
<Callout type="tip" title="¿CASE o FROM VALUES?">
...
<CommandTable commands={[
  ...
  { command: "RENAME TO nuevo_nombre", description: "Cambia el nombre de la tabla" },
